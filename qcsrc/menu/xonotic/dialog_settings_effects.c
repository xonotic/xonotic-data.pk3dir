...
void XonoticEffectsSettingsTab_fill(entity me)
{
	...
	me.TD(me, 1, 1.5, e = makeXonoticCheckBox(1, "mod_q3bsp_nolightmaps", _("Use lightmaps")));
	...
	me.TR(me);
		...
		me.TD(me, 1, 1.5, e = makeXonoticCheckBox(0, "r_glsl_offsetmapping_reliefmapping", _("Relief mapping")));
