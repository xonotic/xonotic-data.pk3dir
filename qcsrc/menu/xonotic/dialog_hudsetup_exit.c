...
void fillXonoticHUDExitDialog(entity me)
{
	...
	me.TR(me);
		me.TD(me, 1, 1.2, e = makeXonoticTextLabel(0, "Team Color:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0, 1, 0.01, "hud_bg_color_team"));
	me.TR(me);
		me.TD(me, 1, 1.4, e = makeXonoticTextLabel(0, "Background Alpha:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0.1, 1, 0.01, "hud_bg_alpha"));
	me.TR(me);
		me.TD(me, 1, 1.4, e = makeXonoticTextLabel(0, "Foreground Alpha:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0.1, 1, 0.01, "hud_fg_alpha"));
	me.TR(me);
		me.TD(me, 1, 1.4, e = makeXonoticTextLabel(0, "Progress Bar Alpha:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0.1, 1, 0.01, "hud_progressbar_alpha"));
	me.TR(me);
	me.TR(me);
		me.TD(me, 1, 4, makeXonoticTextLabel(0, "Dock Settings:"));
	me.TR(me);
		me.TD(me, 1, 1.2, e = makeXonoticTextLabel(0, "Team Color:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0, 1, 0.01, "hud_dock_color_team"));
	me.TR(me);	
		me.TD(me, 1, 1.4, e = makeXonoticTextLabel(0, "Dock Alpha:"));
			me.TD(me, 1, 3, e = makeXonoticSlider(0.1, 1, 0.01, "hud_dock_alpha"));
	me.TR(me);
	me.TR(me);
