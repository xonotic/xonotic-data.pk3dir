...
void XonoticWeaponsDialog_fill(entity me)
{
	...
	me.TR(me);
		me.TD(me, 1, 3, makeXonoticTextLabel(0, "Weapon priority list:"));
	me.TR(me);
	...
	me.TR(me);
		me.TDempty(me, 0.2);
		me.TD(me, 1, 1.4, e = makeXonoticRadioButton(1, "cl_gunalign", "4", "Left align"));
			setDependent(e, "r_drawviewmodel", 1, 1);
		me.TD(me, 1, 1.4, e = makeXonoticRadioButton(1, "cl_gunalign", "3", "Right align"));
			setDependent(e, "r_drawviewmodel", 1, 1);
	me.TR(me);
